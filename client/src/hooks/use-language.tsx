...
export const translations: Record<Language, Record<string, string>> = {
  de: {
    ...
    "admin.categories.deleteConfirmation": "Sind Sie sicher, dass Sie die Kategorie \"{name}\" löschen möchten? Diese Aktion ist unwiderruflich und kann Produkte betreffen, die mit dieser Kategorie verknüpft sind.",
    "admin.categories.cancelDelete": "Abbrechen",
    "admin.categories.confirmDelete": "Ja, löschen",
    "admin.categories.deleting": "Löschen...",
    "admin.categories.successCreate": "Erfolg",
    "admin.categories.successCreateDesc": "Kategorie wurde erfolgreich hinzugefügt.",
    "admin.categories.successUpdate": "Erfolg",
    "admin.categories.successUpdateDesc": "Kategorie wurde erfolgreich aktualisiert.",
    "admin.categories.successDelete": "Erfolg",
    "admin.categories.successDeleteDesc": "Kategorie wurde erfolgreich gelöscht.",
    "admin.categories.errorCreate": "Fehler",
    "admin.categories.errorCreateDesc": "Beim Hinzufügen der Kategorie ist ein Fehler aufgetreten: {error}",
    "admin.categories.errorUpdate": "Fehler",
    "admin.categories.errorUpdateDesc": "Beim Aktualisieren der Kategorie ist ein Fehler aufgetreten: {error}",
    "admin.categories.errorDelete": "Fehler",
    "admin.categories.errorDeleteDesc": "Beim Löschen der Kategorie ist ein Fehler aufgetreten: {error}",
  ...
  hr: {
    ...
    "admin.colors.addColorDesc": "Popunite podatke o novoj boji i kliknite Spremi za dodavanje.",
    "admin.colors.editColorDesc": "Uredite podatke boje i kliknite Spremi za pohranu promjena.",
    "admin.colors.colorName": "Naziv boje *",
    "admin.colors.colorNamePlaceholder": "Unesite naziv boje",
    "admin.colors.colorCode": "Kod boje (hex) *",
    "admin.colors.colorCodePlaceholder": "Unesite HEX kod boje (npr. #FF5733)",
    "admin.colors.colorCodeHelp": "Koristite valjani HEX kod boje (npr. #FF5733)",
    "admin.colors.colorDescription": "Opis boje",
    "admin.colors.colorDescriptionPlaceholder": "Unesite opis boje",
    "admin.colors.colorStatus": "Status boje",
    "admin.colors.colorStatusHelp": "Neaktivne boje neće biti dostupne za odabir na proizvodima",
    ...
    "admin.colors.deleteConfirmation": "Jeste li sigurni da želite obrisati boju \"{name}\"? Ova radnja je nepovratna i može utjecati na proizvode koji koriste ovu boju.",
    "admin.colors.cancelDelete": "Odustani",
    "admin.colors.confirmDelete": "Da, obriši",
    "admin.colors.deleting": "Brisanje...",
    "admin.colors.successCreate": "Uspjeh",
    "admin.colors.successCreateDesc": "Boja je uspješno dodana.",
    "admin.colors.successUpdate": "Uspjeh",
    "admin.colors.successUpdateDesc": "Boja je uspješno ažurirana.",
    "admin.colors.successDelete": "Uspjeh",
    "admin.colors.successDeleteDesc": "Boja je uspješno obrisana.",
    "admin.colors.errorCreate": "Greška",
    "admin.colors.errorCreateDesc": "Došlo je do greške prilikom dodavanja boje: {error}",
  ...
  en: {
    ...
    "admin.categories.subtitle": "Manage product categories in your store",
    "admin.categories.allCategories": "All Categories",
    "admin.categories.allCategoriesDesc": "List of all product categories in the store",
    "admin.categories.noCategories": "No categories available. Add your first category.",
    "admin.categories.image": "Image",
    "admin.categories.name": "Name",
    "admin.categories.description": "Description",
    "admin.categories.actions": "Actions",
    "admin.categories.addCategory": "Add new category",
    "admin.categories.editCategory": "Edit category",
    "admin.categories.addCategoryDesc": "Fill in the details about the new category and click Save to add it.",
    "admin.categories.editCategoryDesc": "Edit the category details and click Save to store changes.",
    "admin.categories.categoryName": "Category name *",
    "admin.categories.categoryNamePlaceholder": "Enter category name",
    "admin.categories.categoryDescription": "Category description *",
    "admin.categories.categoryDescriptionPlaceholder": "Enter category description",
    "admin.categories.categoryDescriptionHelp": "Describe the category to give customers more information.",
    "admin.categories.categoryImageUrl": "Category image URL",
    "admin.categories.categoryImageUrlPlaceholder": "Enter category image URL",
    "admin.categories.categoryImageUrlHelp": "Add a URL to an image that best represents this category.",
    ...
    // Admin Scents Page
    "admin.scents.title": "Scents",
    "admin.scents.subtitle": "Manage product scents in your store",
    "admin.scents.allScents": "All Scents",
    "admin.scents.allScentsDesc": "List of all product scents in the store",
    "admin.scents.noScents": "No scents available. Add your first scent.",
    "admin.scents.id": "ID",
    "admin.scents.name": "Name",
    "admin.scents.description": "Description",
    "admin.scents.status": "Status",
    "admin.scents.actions": "Actions",
    "admin.scents.active": "Active",
    "admin.scents.inactive": "Inactive",
    "admin.scents.addScent": "Add new scent",
    "admin.scents.editScent": "Edit scent",
    "admin.scents.addScentDesc": "Fill in the details for the new scent and click Save to add it.",
    "admin.scents.editScentDesc": "Edit the scent details and click Save to store changes.",
    "admin.scents.scentName": "Scent name *",
    "admin.scents.scentNamePlaceholder": "Enter scent name",
    "admin.scents.scentDescription": "Scent description *",
    "admin.scents.scentDescriptionPlaceholder": "Enter scent description",
    "admin.scents.scentDescriptionHelp": "Describe the scent to provide more information to customers.",
    ...
    "admin.scents.successCreate": "Success",
    "admin.scents.successCreateDesc": "Scent has been successfully added.",
    "admin.scents.successUpdate": "Success",
    "admin.scents.successUpdateDesc": "Scent has been successfully updated.",
    "admin.scents.successDelete": "Success",
    "admin.scents.successDeleteDesc": "Scent has been successfully deleted.",
    "admin.scents.errorCreate": "Error",
    "admin.scents.errorCreateDesc": "An error occurred while adding the scent: {error}",
    "admin.scents.errorUpdate": "Error",
    "admin.scents.errorUpdateDesc": "An error occurred while updating the scent: {error}",
    "admin.scents.errorDelete": "Error",
    "admin.scents.errorDeleteDesc": "An error occurred while deleting the scent: {error}",
    
    // Admin Colors Page
    "admin.colors.title": "Colors",
    "admin.colors.subtitle": "Manage product colors in your store",
    "admin.colors.allColors": "All Colors",
    "admin.colors.allColorsDesc": "List of all product colors in the store",
    ...
    "admin.colors.addColorDesc": "Fill in the details for the new color and click Save to add it.",
    "admin.colors.editColorDesc": "Edit the color details and click Save to store changes.",
    "admin.colors.colorName": "Color name *",
    "admin.colors.colorNamePlaceholder": "Enter color name",
    "admin.colors.colorDescription": "Color description *",
    "admin.colors.colorDescriptionPlaceholder": "Enter color description",
    "admin.colors.colorDescriptionHelp": "Describe the color to provide more information to customers.",
    "admin.colors.colorCode": "Color code *",
    "admin.colors.colorCodePlaceholder": "Enter color code (e.g. #FF5733)",
    "admin.colors.colorCodeHelp": "Enter a valid hex color code (e.g. #FF5733)",
    "admin.colors.colorStatus": "Color status",
    "admin.colors.colorStatusHelp": "Inactive colors won't be available for selection by customers",
    ...
    "admin.colors.deleteConfirmation": "Are you sure you want to delete the color \"{name}\"? This action cannot be undone.",
    "admin.colors.cancelDelete": "Cancel",
    "admin.colors.confirmDelete": "Yes, delete",
    "admin.colors.deleting": "Deleting...",
    "admin.colors.successCreate": "Success",
    "admin.colors.successCreateDesc": "Color has been successfully added.",
    "admin.colors.successUpdate": "Success",
    "admin.colors.successUpdateDesc": "Color has been successfully updated.",
    "admin.colors.successDelete": "Success",
    "admin.colors.successDeleteDesc": "Color has been successfully deleted.",
    "admin.colors.errorCreate": "Error",
    "admin.colors.errorCreateDesc": "An error occurred while adding the color: {error}",
    "admin.colors.errorUpdate": "Error",
    "admin.colors.errorUpdateDesc": "An error occurred while updating the color: {error}",
    "admin.colors.errorDelete": "Error",
    "admin.colors.errorDeleteDesc": "An error occurred while deleting the color: {error}",
    ...
    "admin.collections.collectionDescriptionHelp": "Describe the collection to provide more information to customers.",
    ...
    "admin.orders.subtitle": "Manage and monitor customer orders",
    "admin.orders.allOrders": "All Orders",
    "admin.orders.allOrdersDesc": "List of all orders in the store",
    "admin.orders.noOrders": "No orders to display",
    "admin.orders.id": "ID",
    ...
    "admin.orders.generateInvoice": "Generate invoice",
    ...
    "admin.orders.customerPhone": "Phone",
    "admin.orders.customerAddress": "Address",
    "admin.orders.customerCity": "City",
    "admin.orders.customerPostalCode": "Postal code",
    "admin.orders.customerCountry": "Country",
    ...
    "admin.invoices.subtitle": "Manage and monitor invoices",
    "admin.invoices.allInvoices": "All Invoices",
    "admin.invoices.allInvoicesDesc": "List of all invoices in the system",
    "admin.invoices.noInvoices": "No invoices to display",
    "admin.invoices.id": "ID",
    "admin.invoices.number": "Invoice number",
    "admin.invoices.customer": "Customer",
    "admin.invoices.orderNumber": "Order number",
    "admin.invoices.date": "Date",
    "admin.invoices.total": "Total",
    "admin.invoices.status": "Status",
    "admin.invoices.actions": "Actions",
    "admin.invoices.viewDetails": "View details",
    "admin.invoices.downloadInvoice": "Download invoice",
    "admin.invoices.sendInvoice": "Send invoice",
    "admin.invoices.deleteInvoice": "Delete invoice",
    "admin.invoices.invoiceDetails": "Invoice details",
    "admin.invoices.invoiceNumber": "Invoice number",
    "admin.invoices.invoiceDate": "Invoice date",
    "admin.invoices.customerInformation": "Customer information",
    "admin.invoices.companyInformation": "Company information",
    "admin.invoices.companyName": "Company name",
    "admin.invoices.companyAddress": "Company address",
    ...
    "admin.users.subtitle": "Manage user accounts",
    "admin.users.allUsers": "All Users",
    "admin.users.allUsersDesc": "List of all user accounts in the system",
    "admin.users.noUsers": "No users to display",
    "admin.users.id": "ID",
    ...
    "admin.scents.subtitle": "Manage product scents in your store",
    "admin.scents.allScents": "All Scents",
    "admin.scents.allScentsDesc": "List of all available scents for your products",
    "admin.scents.noScents": "No scents available. Add your first scent.",
    "admin.scents.id": "ID",
    "admin.scents.name": "Name",
    "admin.scents.description": "Description",
    ...
    "admin.scents.addScent": "Add new scent",
    "admin.scents.editScent": "Edit scent",
    "admin.scents.addScentDesc": "Fill in the details about the new scent and click Save to add it.",
    "admin.scents.editScentDesc": "Edit the scent details and click Save to store changes.",
    "admin.scents.scentName": "Scent name *",
    "admin.scents.scentNamePlaceholder": "Enter scent name",
    "admin.scents.scentDescription": "Scent description *",
    "admin.scents.scentDescriptionPlaceholder": "Enter scent description",
    "admin.scents.scentStatus": "Scent status",
    "admin.scents.scentStatusHelp": "Inactive scents won't be available for selection on products",
    "admin.scents.cancel": "Cancel",
    "admin.scents.save": "Save scent",
    "admin.scents.saveChanges": "Save changes",
    "admin.scents.saving": "Saving...",
    "admin.scents.updating": "Updating...",
    "admin.scents.deleteScent": "Delete scent",
    "admin.scents.deleteConfirmation": "Are you sure you want to delete the scent \"{name}\"? This action is irreversible and may affect products using this scent.",
    "admin.scents.cancelDelete": "Cancel",
    "admin.scents.confirmDelete": "Yes, delete",
    "admin.scents.deleting": "Deleting...",
    "admin.scents.successCreate": "Success",
    ...
    "admin.colors.addColor": "Add new color",
    "admin.colors.editColor": "Edit color",
    "admin.colors.addColorDesc": "Fill in the details about the new color and click Save to add it.",
    "admin.colors.editColorDesc": "Edit the color details and click Save to store changes.",
    "admin.colors.colorName": "Color name *",
    "admin.colors.colorNamePlaceholder": "Enter color name",
    "admin.colors.colorCode": "Color code (hex) *",
    "admin.colors.colorCodePlaceholder": "Enter HEX color code (e.g., #FF5733)",
    "admin.colors.colorCodeHelp": "Use a valid HEX color code (e.g., #FF5733)",
    "admin.colors.colorDescription": "Color description",
    "admin.colors.colorDescriptionPlaceholder": "Enter color description",
    "admin.colors.colorStatus": "Color status",
    "admin.colors.colorStatusHelp": "Inactive colors won't be available for selection on products",
    "admin.colors.cancel": "Cancel",
    "admin.colors.save": "Save color",
    "admin.colors.saveChanges": "Save changes",
    "admin.colors.saving": "Saving...",
    "admin.colors.updating": "Updating...",
    "admin.colors.deleteColor": "Delete color",
    "admin.colors.deleteConfirmation": "Are you sure you want to delete the color \"{name}\"? This action is irreversible and may affect products using this color.",
    "admin.colors.cancelDelete": "Cancel",
    "admin.colors.confirmDelete": "Yes, delete",
    "admin.colors.deleting": "Deleting...",
    "admin.colors.successCreate": "Success",
  ...
  it: {
    ...
    "admin.colors.addColorDesc": "Compila i dettagli del nuovo colore e clicca su Salva per aggiungerlo.",
    "admin.colors.editColorDesc": "Modifica i dettagli del colore e clicca su Salva per memorizzare le modifiche.",
    "admin.colors.colorName": "Nome colore *",
    "admin.colors.colorNamePlaceholder": "Inserisci il nome del colore",
    "admin.colors.colorCode": "Codice colore (hex) *",
    "admin.colors.colorCodePlaceholder": "Inserisci il codice HEX del colore (es. #FF5733)",
    "admin.colors.colorCodeHelp": "Utilizza un codice colore HEX valido (es. #FF5733)",
    "admin.colors.colorDescription": "Descrizione colore",
    "admin.colors.colorDescriptionPlaceholder": "Inserisci la descrizione del colore",
    "admin.colors.colorStatus": "Stato colore",
    "admin.colors.colorStatusHelp": "I colori inattivi non saranno disponibili per la selezione sui prodotti",
    ...
    "admin.colors.successCreate": "Successo",
    "admin.colors.successCreateDesc": "Il colore è stato aggiunto con successo.",
    "admin.colors.successUpdate": "Successo",
    "admin.colors.successUpdateDesc": "Il colore è stato aggiornato con successo.",
    "admin.colors.successDelete": "Successo",
    "admin.colors.successDeleteDesc": "Il colore è stato eliminato con successo.",
    "admin.colors.errorCreate": "Errore",
    "admin.colors.errorCreateDesc": "Si è verificato un errore durante l'aggiunta del colore: {error}",
    "admin.colors.errorUpdate": "Errore",
    "admin.colors.errorUpdateDesc": "Si è verificato un errore durante l'aggiornamento del colore: {error}",
    "admin.colors.errorDelete": "Errore",
    "admin.colors.errorDeleteDesc": "Si è verificato un errore durante l'eliminazione del colore: {error}",
  ...
  sl: {
    ...
    "admin.colors.colorName": "Ime barve *",
    "admin.colors.colorNamePlaceholder": "Vnesite ime barve",
    "admin.colors.colorCode": "Koda barve (hex) *",
    "admin.colors.colorCodePlaceholder": "Vnesite HEX kodo barve (npr. #FF5733)",
    "admin.colors.colorCodeHelp": "Uporabite veljavno HEX kodo barve (npr. #FF5733)",
    "admin.colors.colorDescription": "Opis barve",
    "admin.colors.colorDescriptionPlaceholder": "Vnesite opis barve",
    "admin.colors.colorStatus": "Status barve",
    "admin.colors.colorStatusHelp": "Neaktivne barve ne bodo na voljo za izbiro pri izdelkih",
    ...
    "admin.colors.deleteConfirmation": "Ali ste prepričani, da želite izbrisati barvo \"{name}\"? To dejanje je nepovratno in lahko vpliva na izdelke, ki uporabljajo to barvo.",
    "admin.colors.cancelDelete": "Prekliči",
    "admin.colors.confirmDelete": "Da, izbriši",
    "admin.colors.deleting": "Brisanje...",
    "admin.colors.successCreate": "Uspeh",
    "admin.colors.successCreateDesc": "Barva je bila uspešno dodana.",
    "admin.colors.successUpdate": "Uspeh",
    "admin.colors.successUpdateDesc": "Barva je bila uspešno posodobljena.",
    "admin.colors.successDelete": "Uspeh",
    "admin.colors.successDeleteDesc": "Barva je bila uspešno izbrisana.",
    "admin.colors.errorCreate": "Napaka",
    "admin.colors.errorCreateDesc": "Pri dodajanju barve je prišlo do napake: {error}",
    "admin.colors.errorUpdate": "Napaka",
    "admin.colors.errorUpdateDesc": "Pri posodabljanju barve je prišlo do napake: {error}",
    "admin.colors.errorDelete": "Napaka",
    "admin.colors.errorDeleteDesc": "Pri brisanju barve je prišlo do napake: {error}",

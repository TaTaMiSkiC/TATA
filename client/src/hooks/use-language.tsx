...
export const translations: Record<Language, Record<string, string>> = {
  de: {
    ...
    'home.autumnCollectionDesc': 'Entdecken Sie unsere neue Kollektion von Herbstdüften. Warme und angenehme Düfte, die Ihr Zuhause an kühleren Tagen mit einem Gefühl von Gemütlichkeit und Wärme erfüllen.',
    'home.loading': 'Laden...',
    'home.noProducts': 'Dieser Kollektion wurden noch keine Produkte hinzugefügt.',
  ...
  hr: {
    ...
    'home.autumnCollectionDesc': 'Otkrijte našu novu kolekciju jesenskih mirisa. Topli i ugodni mirisi koji će vaš dom ispuniti osjećajem udobnosti i topline tijekom hladnijih dana.',
  ...
  en: {
    ...
    'home.autumnCollectionDesc': 'Discover our new collection of autumn scents. Warm and pleasant fragrances that will fill your home with a sense of comfort and warmth during the cooler days.',
  ...
  it: {
    ...
    'home.storyDescription': 'Ogni nostra candela è realizzata con cura e amore, prestando attenzione a ogni dettaglio - dalla selezione delle migliori fragranze alla rifinitura dell\'aspetto estetico. Siamo orgogliosi del nostro artigianato e della passione con cui affrontiamo ogni prodotto.',
    'home.naturalIngredients': 'Ingredienti naturali',
    'home.naturalIngredientsDesc': 'Utilizziamo solo cera di soia naturale e oli essenziali',
    ...
    'home.autumnCollectionDesc': 'Scopri la nostra nuova collezione di fragranze autunnali. Profumi caldi e piacevoli che riempiranno la tua casa con un senso di comfort e calore durante le giornate più fresche.',
    'home.loading': 'Caricamento...',
    'home.noProducts': 'Non sono ancora stati aggiunti prodotti a questa collezione.',
  ...
  sl: {
    ...
    'home.storyDescription': 'Vsaka naša sveča je izdelana s skrbjo in ljubeznijo, s pozornostjo na vsako podrobnost - od izbire najboljših dišav do končnega estetskega videza. Ponosni smo na naše rokodelstvo in strast, s katero pristopamo k vsakemu izdelku.',
    'home.naturalIngredients': 'Naravne sestavine',
    'home.naturalIngredientsDesc': 'Uporabljamo samo naravni sojin vosek in eterična olja',
    ...
    'home.autumnCollection': 'Jesenska kolekcija',
    'home.autumnCollectionDesc': 'Odkrijte našo novo kolekcijo jesenskih dišav. Tople in prijetne dišave, ki bodo vaš dom v hladnejših dneh napolnile z občutkom udobja in topline.',

 ...
 */
export function generateVerificationEmailTemplate(username: string, verificationLink: string, language: string = 'de'): string {
  ...
  const translations: Record<string, Record<string, string>> = {
    de: {
      ...
      message: 'Vielen Dank für Ihre Registrierung bei Kerzenwelt by Dani. Bitte bestätigen Sie Ihre E-Mail-Adresse, um Ihre Registrierung abzuschließen.',
    ...
    hr: {
      ...
      message: 'Hvala što ste se registrirali na Kerzenwelt by Dani. Molimo potvrdite svoju e-mail adresu kako biste završili registraciju.',
    ...
    en: {
      ...
      message: 'Thank you for registering with Kerzenwelt by Dani. Please verify your email address to complete your registration.',
      button: 'Verify Email',
    ...
    it: {
      ...
      message: 'Grazie per esserti registrato su Kerzenwelt by Dani. Verifica il tuo indirizzo email per completare la registrazione.',
    ...
    sl: {
      ...
      message: 'Zahvaljujemo se vam za registracijo na Kerzenwelt by Dani. Prosimo, potrdite svoj e-poštni naslov za dokončanje registracije.',
      button: 'Potrdi e-pošto',
      expires: 'Ta povezava velja 24 ur.',
      ignore: 'Če tega e-poštnega sporočila niste zahtevali, ga lahko prezrete.',
      thanks: 'Hvala,',
